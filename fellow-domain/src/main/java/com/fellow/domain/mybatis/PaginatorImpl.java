 ...
 */
public class PaginatorImpl implements Serializable {

    private static final long serialVersionUID = -2927071322180757739L;

    private static final int DEFAULT_SLIDERS_COUNT = 5;
    private static final int DEFAULT_SLIDERS_MULTIPLE_COUNT = 5;
    ...
    public PaginatorImpl(int page, int limit, int totalCount) {
        super();
        this.limit = limit;
    ...
    public Integer[] getSliderMultiple() {
        return slider(DEFAULT_SLIDERS_MULTIPLE_COUNT);
    }
    ...
    public Integer[] sliderMultiple(int slidersCount) {
        return generateMultipleLinkPageNumbers(getPage(), (int) getTotalPages(), slidersCount);
    }
    ...
    private static Integer[] generateMultipleLinkPageNumbers(int currentPageNumber, int lastPageNumber, int count) {
        int startPageNumber = 1;
        if (currentPageNumber > count) {
            startPageNumber = (currentPageNumber - currentPageNumber % count);
        }
