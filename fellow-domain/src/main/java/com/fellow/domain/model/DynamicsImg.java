...
public class DynamicsImg extends BaseDomain implements java.io.Serializable{
    ...
    private Long id;
    /**personal_dynamics 表主键       db_column: personal_id*/
    ...
    public boolean equals(Object obj) {
        if(obj instanceof DynamicsImg == false) return false;
        if(this == obj) return true;
        DynamicsImg other = (DynamicsImg)obj;
