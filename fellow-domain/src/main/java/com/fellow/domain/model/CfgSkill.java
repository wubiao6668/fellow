...
public class CfgSkill extends BaseDomain implements java.io.Serializable{
    ...
    public boolean equals(Object obj) {
        if(obj instanceof CfgSkill == false) return false;
        if(this == obj) return true;
        CfgSkill other = (CfgSkill)obj;
