...
public class PersonalDynamicsUp extends BaseDomain implements java.io.Serializable{
    ...
    private Long id;
    /**personal_dynamics_comment 表主键       db_column: personal_id*/
    @NotNull @Max(9223372036854775807L)
    private Long personalId;
    /**点赞用户       db_column: account*/
    @NotBlank @Length(max=255)
    private String account;
    /**100-赞 200-爱心       db_column: thumbs_type*/
    @NotNull @Max(32767)
    ...
    public PersonalDynamicsUp(){
    }

    public PersonalDynamicsUp(java.lang.Long id){
        this.id = id;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("ThumbsType",getThumbsType())
    ...
    public boolean equals(Object obj) {
        if(obj instanceof PersonalDynamicsUp == false) return false;
        if(this == obj) return true;
        PersonalDynamicsUp other = (PersonalDynamicsUp)obj;
    ...
    private String thumbsTypeName;
    public String getThumbsTypeName() {
        return thumbsTypeName;
    }
    public void setThumbsTypeName(String thumbsTypeName) {
        this.thumbsTypeName = thumbsTypeName;
    }
}
