...
public class SystemBaseSet extends BaseDomain implements java.io.Serializable{
    ...
    /**私信权限 100接收  200-不接受       db_column: stranger_message*/
    @NotNull @Max(32767)
    private Integer strangerMessage;
    /**个人动态权限 100-对自己可见 200-对好友可见 300-所有人可见       db_column: dyn_authority*/
    @NotNull @Max(32767)
    private Integer dynAuthority;
    /**关于我权限 100-对自己可见 200-对好友可见 300-所有人可见       db_column: me_authority*/
    @NotNull @Max(32767)
    private Integer meAuthority;
    /**个人信息权限 100-对自己可见 200-对好友可见 300-所有人可见       db_column: info_authority*/
    @NotNull @Max(32767)
	...
	public SystemBaseSet(){
	}

	public SystemBaseSet(Long id){
		this.id = id;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("StrangerMessage",getStrangerMessage())
            .append("DynAuthority",getDynAuthority())
            .append("MeAuthority",getMeAuthority())
            .append("InfoAuthority",getInfoAuthority())
    ...
    public boolean equals(Object obj) {
        if(obj instanceof SystemBaseSet == false) return false;
        if(this == obj) return true;
        SystemBaseSet other = (SystemBaseSet)obj;
