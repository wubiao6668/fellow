...
public class PostCommentReply extends BaseDomain implements java.io.Serializable{
    ...
    private Long postId;
    /**回复表主键       db_column: reply_id*/
    @NotNull @Max(9223372036854775807L)
    private Long replyId;
    /**主题标题       db_column: title*/
    @NotBlank @Length(max=255)
    private String title;
    /**帖子类型  100-寻物启事       db_column: post_type*/
    @NotNull @Max(32767)
    ...
    @NotBlank @Length(max=600)
    private String content;
    /**回复时间       db_column: reply_time*/
    @NotNull
    private Date replyTime;
    /**帖子删除标识 100-未删除 200-已经删除       db_column: post_delete*/
    @NotNull @Max(32767)
    ...
    public PostCommentReply(java.lang.Long id){
        this.id = id;
    }
    ...
    /**
     * 设置帖子删除标识 100-未删除 200-已经删除
     */
    public void setPostDelete(Integer value) {
        this.postDelete = value;
    }

    /**
     * 获得帖子删除标识 100-未删除 200-已经删除
     */
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("PostDelete",getPostDelete())
    ...
    public boolean equals(Object obj) {
        if(obj instanceof PostCommentReply == false) return false;
        if(this == obj) return true;
        PostCommentReply other = (PostCommentReply)obj;
