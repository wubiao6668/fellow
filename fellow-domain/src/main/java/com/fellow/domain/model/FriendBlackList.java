...
public class FriendBlackList extends BaseDomain implements java.io.Serializable{
	...
	public FriendBlackList(){
	}

	public FriendBlackList(Long id){
		this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof FriendBlackList == false) return false;
        if(this == obj) return true;
        FriendBlackList other = (FriendBlackList)obj;
