...
public class PostCommentReplyQuery extends QueryDomain implements Serializable {
    ...
    public int getCommontGroupNum() {
        return commontGroupNum;
    }

    public void setCommontGroupNum(int commontGroupNum) {
        this.commontGroupNum = commontGroupNum;
    }
