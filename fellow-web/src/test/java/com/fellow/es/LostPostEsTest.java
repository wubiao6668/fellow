...
public class LostPostEsTest {
    ...
    public void testRepository() {
        ...
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-防霾口罩可以重复使用吗？");
...
//        Page<LostPostEsDomain> postEsDomainPage = lostPostRepository.search(queryBuilder, new PageRequest(0, 20));
    ...
    public void beforeTest() {
        ...
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "辟谣｜超薄纸尿裤透气性一定好吗？");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-测了38款常温牛奶，这三款一生推！");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-九成家长都不知道，安全座椅应该这样选");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-12款无绳吸尘器良心评测，但结果很扎心");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-问天问大地，为什么荧光增白剂致癌这个谣言怎么辟都不倒？？");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-用卫生棉条会破处吗？会疼吗？塞不进去怎么办？一篇终结所有疑惑！");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-14款儿童酱油评测，卖点全部打脸！");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-11款扫地机器人竞赛，小米活好、美的“智障”、还发现几个戏精……");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-面膜敷的好，年轻不显老，可你真的敷对了么？");
        ...
        lostPostEsDomain = new LostPostEsDomain();
        lostPostEsDomain.setId(System.nanoTime());
        lostPostEsDomain.setTitle(RandomStringUtils.randomAlphabetic(4) + "-牙齿美白小窍门到底靠不靠谱？");
