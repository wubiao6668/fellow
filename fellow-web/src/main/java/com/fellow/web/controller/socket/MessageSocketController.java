...
//        messagingTemplate.convertAndSendToUser("test","/topic/greetings", new Greeting("Hello, " + message.getName() + "!"));
//
...
//    }
    ...
    public void send(String content) {
        ...
        messagingTemplate.convertAndSendToUser(contents[0], "/message", new Greeting(contents[1]));
    }
