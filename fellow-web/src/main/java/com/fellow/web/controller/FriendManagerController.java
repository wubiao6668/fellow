...
@Controller
@RequestMapping(FriendManagerController.VIEW_PATH)
public class FriendManagerController extends WebAbstract<FriendService> {
    public static final String VIEW_PATH = "/friend/friendManager";
